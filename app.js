  ...
  "courses": {
    "104041": {
      ...
      "tasks": [
        ...
        {
          "id": "task_moodle_11028_1789652686032",
          "xp": 50,
          "type": "assignment",
          "title": "הגשת גיליון 3",
          "source": "moodle",
          "status": "done",
          "dueDate": "2027-07-03 09:00",
          "completed": true,
          "moodleUid": "11028@moodle25.technion.ac.il",
          "dueTimestamp": 1814605200000,
          "moodleEventId": "11028"
        }
      ],
      "status": "mastered",
    ...
    "104043": {
      ...
      "tasks": [
        ...
        {
          "id": "task_moodle_126492_1789652686032",
          "xp": 50,
          "type": "assignment",
          "title": "העלאת אישורי זכאות למועד מילואים",
          "source": "moodle",
          "status": "done",
          "dueDate": "2026-09-23 20:59",
          "completed": true,
          "moodleUid": "126492@moodle25.technion.ac.il",
          "dueTimestamp": 1790197140000,
          "moodleEventId": "126492"
        }
      ],
      "status": "mastered",
      "credits": 5,
    ...
    "314533": {
      ...
      "tasks": [
        ...
        {
          "id": "task_moodle_45587_1789652686031",
          "xp": 50,
          "type": "assignment",
          "title": "ערעורים - מועד ב'",
          "source": "moodle",
          "status": "done",
          "dueDate": "2026-09-14 20:59",
          "completed": true,
          "moodleUid": "45587@moodle25.technion.ac.il",
          "dueTimestamp": 1789419540000,
          "moodleEventId": "45587"
        }
      ],
      "status": "mastered",
    ...
    "034061": {
      ...
      "tasks": [
        ...
        {
          "id": "task_moodle_125471_1789652686032",
          "xp": 50,
          "type": "assignment",
          "title": "תיבת ערעורים - זמינה עד 18.9.26",
          "source": "moodle",
          "status": "done",
          "dueDate": "2026-09-17 21:00",
          "completed": true,
          "moodleUid": "125471@moodle25.technion.ac.il",
          "dueTimestamp": 1789678800000,
          "moodleEventId": "125471"
        }
      ],
      "status": "mastered",
      "credits": 3.5,
  ...
  "revisions": [
    ...
    },
    {
      ...
      "stateSnapshot": {
            ...
            "tasks": [
              {
                ...
                "xp": 50,
                "type": "hw",
                "title": "תרגיל בית 1: מכניקה יחסותית וחוקי שימור",
                "completed": false
              },
              {
                "id": "114071_ex",
            ...
            "tasks": [
              {
                ...
                "xp": 60,
                "type": "hw",
                "title": "תרגיל בית 1: שדה חשמלי, מגנטיות וגלי אור",
                "completed": false
              },
              {
                "id": "114075_ex",
        ...
        "moodleCalendarUrl": "https://moodle25.technion.ac.il/calendar/export_execute.php?userid=43774&authtoken=a124e33d97c0722e89374bea7fddb03632778eee&preset_what=all&preset_time=custom",
    ...
    },
    {
      ...
      "courses": [
        ...
        },
        {
          "code": "00350022",
          "list": "A",
          "name": "אלמנטים סופיים לאנליזה הנדסית",
          "altCode": "035022",
          "credits": 3,
          "prereqs": [
            "00340053",
    ...
    },
    {
      ...
      "courses": [
        ...
        },
        {
          "code": "00340406",
          "list": "C",
          "name": "מעבדה מתקדמת לבקרה ואוטומציה",
          "altCode": "034406",
          "credits": 2.5,
          "prereqs": [
            "00340040"
    ...
    if (window.AuthSync && typeof window.AuthSync.init === 'function') {
        ...
        if (userState && userState.courses && Object.keys(userState.courses).length > 0) {
            ...
            if (typeof PRELOADED_USER_STATE !== 'undefined' && PRELOADED_USER_STATE.courses) {
                ...
                if ((!gameState.degreePlan || !Array.isArray(gameState.degreePlan) || gameState.degreePlan.length === 0) && PRELOADED_USER_STATE.degreePlan) {
...
function notifyStateChanged(options = {}) {
    ...
    try {
        ...
        if (options.forceAll) {
            ...
            if (typeof DegreePlanner !== 'undefined' && DegreePlanner.renderDegreePlanner) DegreePlanner.renderDegreePlanner();
...
const APP_CURRENT_REVISION = {
    code: "REV-2026.09.17-v1.8.21",
    build: "180000",
    date: "2026-09-17 21:55",
    description: "גרסה 1.8.21: הטמעת סמל האפליקציה החדש (גלגל שיניים, מבחנה וזרוע רובוטית עם גריפר בעיצוב HUD ניאון-ציאן כהה), הוספת cache-busters לטעינה מיידית, ועדכון כל סוגי האייקונים"
};
...
// Helper: Schedule native Android OS-level alarm via NotificationTriggers API (TimestampTrigger)
async function scheduleNativeTimestampTrigger(classItem, timestampMs) {
    if (typeof Notification === 'undefined' || Notification.permission !== 'granted') return;
    if (!('serviceWorker' in navigator) || typeof TimestampTrigger === 'undefined') return;

    try {
        const reg = await navigator.serviceWorker.ready;
        if (reg && reg.showNotification && 'showTrigger' in Notification.prototype) {
            const courseName = classItem.courseName || 'שיעור אקדמי';
            const type = classItem.type || 'הרצאה / תרגול';
            const typeShort = type.split(' ')[0] || '';
            const tag = `ast-trigger-${classItem.courseId || 'c'}-${(classItem.startTime || '0000').replace(':', '')}`;

            await reg.showNotification(`⏰ בעוד כ-10 דק׳: ${courseName} (${typeShort})`, {
                body: `📚 ${type}\n⏰ שעות: ${classItem.startTime} - ${classItem.endTime}\n📍 ${classItem.room || 'טכניון'}`,
                icon: 'icon.png',
                badge: 'icon.png',
                tag: tag,
            ...
            console.log(`[Notifications] Registered OS TimestampTrigger alarm for ${courseName} at ${new Date(timestampMs).toLocaleTimeString()}`);
        }
    } catch (err) {
        // TimestampTrigger may not be supported on this browser version
    }
}
...
async function trigger10MinClassAlert(classItem, isTest = false) {
    ...
    const courseName = classItem.courseName || 'שיעור אקדמי';
    const type = classItem.type || 'הרצאה / תרגול';
    const typeShort = (type.split(' ')[0] || '').replace(/[()]/g, '');
    ...
    // Calculate real-time relative difference to actual current clock time
    const now = new Date();
    let diffMinutes = 10;
    if (!isTest && startTime) {
...
function scheduleTodayClassTimeouts() {
    ...
    dayConfig.classes.forEach(c => {
        ...
        // 1. Register modern OS-level NotificationTrigger (TimestampTrigger) for Android Chrome
        if (delayMs > 0) {
